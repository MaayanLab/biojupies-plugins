...
def plot(enrichment_results, plot_counter):
	...
	# Add table
	s.results_table(enrichment_results['enrichment_dataframe'].copy(), source_label='miRNA', target_label='target')
	...
	s.download_button(results_txt, 'Download Results', 'mirna_enrichment_results.txt')
